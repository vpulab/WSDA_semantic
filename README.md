...
* **Model weights**: If you intend on using deeplab please download the [imagenet-pretrained backbone weights](http://www-vpu.eps.uam.es/publications/WSDA_semantic/model_zoo/Imagenet_pretrained/init.pth).

Additional weights can be found in the [publication page](http://www-vpu.eps.uam.es/publications/WSDA_semantic/)
